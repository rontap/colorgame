    ...
    if (!space) { //if level is running currently
        ...
        if ((loopvar.score > 0) || ((loopvar.score <= 0) && (isGiftActive(0)))) { //game keeps on goints
            ...
            $("#main_header").onclick = function() {
                reloadPrompt = confirm("The page will be realoaded and all progress will be lost. Are you sure you want to continue?");
        ...
        // GAME OVER
            ...
            highScore();
            showStatistic(points);
            specialAgoFunction(points); // for ago
