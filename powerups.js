...
if (localStorage.achieveList==undefined)  localStorage.achieveList = "00000000" //storing binary array in numbers because fuck JSON

achieveList=localStorage.achieveList;
...
pwrup =  [
          {
              ...
              require : () => level>50 ,
              runs : () => loopvarDelta=[.80,1],
              icon: "angle-double-up"
          },
          {
              name:'Save The Day',
              before : 'Survive 7 Dooms',
              desc:'20% less dooom',
              require : () => Math.floor(level/loopvar.doomOccurrance)>6 ,
              runs : () => loopvarDelta=[1,1.2],
              icon: "life-ring"
          },
          {
              name:'Eye for an eye',
          ...
          {
              name:'Jackpot',
              before : 'Have 1000 points purely from combos!',
              desc:'50% more points and score from combos',
              require : () => pointsFromCombo1>000 , //!
              runs : () => alert(),
              icon: "gift"
          },
          {
              name:'Headstart I',
              before : 'reach Level 200 on medium',
              desc:'game starts from level 50',
              require : () => (level>200)&&(difficulty>1) ,
              runs : () => level=50,
              icon: "paper-plane"
          },
          {
              ...
              before : 'reach Level 500 on hard',
              require : () => (level>500)&&(difficulty>2)  ,
              runs : () => level=111,
              icon: "rocket"
          },
          {
